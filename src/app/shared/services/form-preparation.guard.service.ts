...
@Injectable()
export class FormPreparationGuard implements CanActivate {
  constructor(
  ...
  canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<boolean> | Promise<boolean> | boolean {
    ...
    switch (route.params.action) {
      ...
      case 'create':
        /**
         *  chỉ cho phép tạo khi chưa tồn tại bản điều kiện dự thầu (condition tender) và đang ở trạng thái DangLapHSDT
         */
        const condition = forkJoin(
          ...
          this.packageService.getTenderConditionSummary(packageId).
