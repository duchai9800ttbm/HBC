...
export class PackageService {
    ...
    createOpportunity(formValue: any): Observable<any> {
        ...
        const inforPackage = {
            ...
            customerId: formValue.customerId.id ? formValue.customerId.id : 0,
            classify: formValue.classify,
            customerContactId: formValue.customerContactId.id ? formValue.customerContactId.id : 0,
            consultantUnit: formValue.consultantUnit.id ? formValue.consultantUnit.id : 0,
