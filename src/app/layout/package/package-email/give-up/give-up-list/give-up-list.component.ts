...
@Component({
  selector: 'app-give-up-list',
  templateUrl: './give-up-list.component.html',
  styleUrls: ['./give-up-list.component.scss']
})
export class GiveUpListComponent implements OnInit {
