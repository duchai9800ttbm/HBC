...
import { SiteSurveyReportComponent } from './site-survey-report/site-survey-report.component';
...
const routes: Routes = [
    {
        ...
        children: [
            ...
            {
                path: 'sitereport',
                loadChildren: './site-survey-report/site-survey-report.module#SiteSurveyReportModule'
            }
        ]
    }
];
